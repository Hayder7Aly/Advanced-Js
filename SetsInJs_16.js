...
// how to remove the repeat values of array using set 

let myArr3 = [1,2,3,4,1,2,3,4,234,232,245,234,83,20,1]
let uniArray = Array.from(new Set(myArr3))
console.log(uniArray);


// trick for you 

let arr = Array.from(new Set([1,2,3,4,5,6,1,2,3,45,6]))
console.log(arr)
